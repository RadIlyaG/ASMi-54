...
#   set gaSet(idGen2) [RLEtxGen::Open $gaSet(comGen2) -package RLSerial] 
...
proc InitEtxGen {gen}  {
  ...
  RLEtxGen::GenConfig $id -updGen all -factory yes -genMode FE -minLen 64 -maxLen 64 \
      -chain 1 -packRate 100 -packType MAC 
...
proc Etx204Refresh {} {
  ...
  foreach gen {1 2} {
    ...
    for {set i 1} {$i<=4} {incr i} {
      puts "\tEtx204 Gen-$gen i-$i Refresh" ; update
